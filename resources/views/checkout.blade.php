                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="billing-details pr-10">
                                                ...
                                                <textarea class="custom-textarea" name="address" placeholder="Your address here..."></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <!-- our order -->
                                                ...
                                                <div id="accordion">
                                                    <div class="panel">
                                                        <h4 class="payment-title box-shadow">
                                                                <input type="radio" value="CC" name="payment"> <span>online payment</span> <br> <br>
                                                        </h4>
                                                        <!--
                                    ...
                                    <div class="col-md-6">
                                        <div class="payment-details p-30">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td class="order-total">Order Total</td>
                                                    <td class="order-total-price">{{$total+100+($total*0.05)}}</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
